package com.work.ssj.redis.aspect;


import com.work.ssj.redis.annotation.RedisCache;
import com.work.ssj.redis.annotation.RedisEvict;
...
public class RedisAspect
{
    ...
    public RedisAspect(RedisUtils redis) {
        this.redis = redis;
    }
     ...
     */
    @Pointcut("@annotation(com.work.ssj.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.work.ssj.redis.annotation.RedisEvict)")
    ...
    public Object WriteReadFromRedis(ProceedingJoinPoint point)
    {
        ...
        {
            logger.error("<====== RedisCache 执行异常: {} ======>", ex.getMessage());
        }
        return null;
    }
